...
import 'package:requenes0397/firebase_options.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title:
            const Text('Zapatería Iker', style: TextStyle(color: Colors.white)),
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Image(
                image: NetworkImage(
                    "https://raw.githubusercontent.com/hernandez5i/img_IOS/main/zapato3.png")),
